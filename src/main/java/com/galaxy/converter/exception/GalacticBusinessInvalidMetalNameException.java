 ...
 *
 */
public class GalacticBusinessInvalidMetalNameException extends GalacticBusinessException {
	 ...
	 * @param message
	 */
	public GalacticBusinessInvalidMetalNameException(String message) {
		super(message);
